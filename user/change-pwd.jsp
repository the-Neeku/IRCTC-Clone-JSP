                ...
                <form action="controller.jsp" method="post" onsubmit="return check()">
                    ...
                    <div class="row">
                        ...
                        <div class="box">
                            ...
                            <label for="pass">New-Password:</label><input type="password" name="pwd" id="pwd" style="width: 65%;"
                                placeholder="Enter new password" required>
                        </div>
                        <div class="box">
                            <i class="fa-solid fa-lock"></i>
                            <label for="pass">Confirm Password:</label><input type="password" name="cpwd" id="cpwd" style="width: 58%;"
                                placeholder="Confirm new password" required>
                        </div>
                        <div class="row mt-3 mb-3 text-center">
                            <div>
                                <button class="btn" type="submit" onclick="check()">Change</button>
                            </div>
                        </div>
                    </div>
                </form>

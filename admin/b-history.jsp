...
<body>
    <div class="container-fluid">
        ...
        <!--navbar end-->
         <div class="row mt-5">
          <div class="col-sm-12">
              <h2 align="center" class=" m-3" style="color: #213D77;">Booking Records</h2>
              <table class="table table-bordered" style="box-shadow: 5px 8px 10px #213D77">
                  ...
                  ResultSet rs=dm.select("select * from bookingrecords left join train_details on bookingrecords.trainid=train_details.id");
                  while(rs.next())
                  {
                      %>
                      <tr>
